(function () {
	...
	/**
	 * @ngdoc function
	 * @name app.module:scheduleModule
	 * @description
	 * # scheduleModule
	 * Module of the app
	 */

  	angular.module('schedule', ['mwl.calendar', 'ui.bootstrap'])
	    .config(function(calendarConfig) {
		    ...
		    calendarConfig.templates.calendarWeekView = '/app/modules/schedule/customCalendarWeekView.html'; //change the month view template to a custom template
		    ...
		    calendarConfig.displayAllMonthEvents = false; //This will display all events on a month view even if they're not in the current month. Default false.
