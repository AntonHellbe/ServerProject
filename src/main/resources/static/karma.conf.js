...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/timestamps/timestampsModule.js',
			'app/modules/timestamps/timestampsCtrl.js',
			'app/modules/timestamps/timestampsRoute.js',
			'app/modules/timestamps/timestampsService.js',
			'app/modules/timestamps/timestamps-test.js',
			...
			'app/modules/pi/piModule.js',
			'app/modules/pi/piCtrl.js',
			'app/modules/pi/piRoute.js',
			'app/modules/pi/piService.js',
			'app/modules/pi/pi-test.js',
			'app/modules/android/androidModule.js',
			'app/modules/android/androidCtrl.js',
